...
function @vctl_cleanup_containers --wraps=vctl\ ps\ -a\ \|\ cut\ -d\ \'\ \'\ -f\ 1\ \|\ tail\ -n\ +4\ \|\ xargs\ vctl\ rm --description alias\ @vctl_cleanup_containers\ vctl\ ps\ -a\ \|\ cut\ -d\ \'\ \'\ -f\ 1\ \|\ tail\ -n\ +4\ \|\ xargs\ vctl\ rm
